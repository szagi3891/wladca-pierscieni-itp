export default function Footer() {
  return (
    <footer className="mt-auto border-t border-[var(--border-gold)] bg-[var(--bg-secondary)]">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-4 text-center">
          <p className="font-display text-sm tracking-[0.3em] text-[var(--gold-ring)]">
            • • • • •
          </p>
          <p className="text-sm text-[var(--parchment-muted)]">
          ...
          <p className="font-display text-xs tracking-widest text-[var(--parchment-muted)]">
